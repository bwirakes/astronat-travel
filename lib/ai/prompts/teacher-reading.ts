...
- Each guideRows body must be specific, not generic: name the actual goal, event score, planet/line/house, dignity, window, or risk it is based on. Timing guideRows are optional and ignored by the current UI.
