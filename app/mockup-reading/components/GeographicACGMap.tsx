...
export function GeographicACGMapLines() {
  const isMobile = false; // We can pass this or calculate it properly
      ...
      <section id="section-map-intro" className="relative min-h-[140vh] w-full flex flex-col items-center justify-center pt-32 pb-40 snap-start">
        <div className="relative z-10 text-center px-6">
          <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-white/20 bg-white/5 backdrop-blur-md mb-8">
             <div className="w-2 h-2 rounded-full bg-[var(--color-y2k-blue)] animate-pulse" />
          ...
          <div className="p-6 md:p-8 rounded-[var(--shape-asymmetric-lg)] bg-black/60 border border-white/10 backdrop-blur-xl max-w-xl mx-auto shadow-2xl relative z-10">
            <p className="font-body text-base md:text-lg text-white/80 leading-relaxed mb-4">
              Now let's zoom out. Astrolocality lines reveal the direct geographic paths where your planets hold their maximum strength across the globe.
            </p>
          </div>
        </div>
      </section>
