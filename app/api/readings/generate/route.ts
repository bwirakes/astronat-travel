...
export async function POST(req: Request) {
  try {
    ...
    // Compute sect from natal Sun position and relocated ASC
    ...
    // AI Storytelling Engine - Vercel AI SDK + Gemini 3.1 Flash Lite
    const aiSystemPrompt = `You are the principal astrologer for AstroNat, a premium, brutalist, Gen-Z/Millennial travel astrology platform. Your voice is direct, architectural, uncompromising, and highly analytical. 
...
{
  "primary": { "label": "MACRO OVERVIEW", "title": "The Astrological Verdict", "content": "..." },
  "highest": { "label": "HIGHEST ENERGY", "title": "[Dynamic Title]", "content": "..." },
  "vulnerable": { "label": "FRICTION POINT", "title": "[Dynamic Title]", "content": "..." },
  "timing": { "label": "OPTIMAL ACTION WINDOW", "title": "Peak Timing: [Date Range]", "content": "..." }
}`;
    ...
    const aiPayload = JSON.stringify({
      ...
      peakTransits: transits.slice(0, 10)
    });
