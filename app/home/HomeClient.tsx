...
import { LifeGoalsButton, CouplesButton, MyChartButton, WorldChartsButton } from "../components/ExploreButtons";
...
export default function HomeClient({ profile, sunSignData, recentSearches }: any) {
    ...
    return (
        <DashboardLayout showBack={false} maxWidth="100%" paddingTop="0" paddingBottom="0">
